...
import { ApiExtraModels, ApiOkResponse, ApiResponse, ApiTags, ApiUnauthorizedResponse, getSchemaPath } from '@nestjs/swagger';
...
export class AuthController {
  ...
  async create(@Body() createAuthDto: UserLoginDto) {
    return new UserLoginResponseDto(await this.authService.login(createAuthDto));
  }
